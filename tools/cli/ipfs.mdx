---
title: "Pinata IPFS CLI commands"
description: "Upload files, manage groups, run gateways, rotate keys, and configure swaps on Pinata directly from your terminal using the IPFS CLI."
icon: "cube"
---
