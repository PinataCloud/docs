---
title: "Pinata CLI overview"
description: "The official Pinata CLI is written in Go and bundles IPFS uploads, gateway management, agent control, and authentication in one binary."
icon: "terminal"
---
