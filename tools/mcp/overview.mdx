---
title: "Pinata MCP server for AI assistants"
description: "Run the Pinata MCP server to give Claude, Cursor, and other AI assistants direct access to IPFS uploads, gateways, and file management."
---
