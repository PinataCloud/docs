---
title: "Pinata MCP server tool reference"
description: "Complete reference for every tool exposed by the Pinata MCP server, including upload, list, delete, and gateway helpers for AI agents."
---
