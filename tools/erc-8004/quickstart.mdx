...
For example agent cards and ready-to-run scripts, check out [erc8004-pinata-example](https://github.com/PinataCloud/erc8004-pinata-example). For an interactive experience, try the wizard:
...
2. **Test ETH** — ~0.1 ETH on Sepolia from the [Alchemy faucet](https://www.alchemy.com/faucets/ethereum-sepolia)
