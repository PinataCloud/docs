---
title: "ERC-8004 service endpoints and IPFS"
description: "Reference for ERC-8004 service endpoint types and how to use Pinata IPFS to host the metadata, manifests, and credentials each agent requires."
---
