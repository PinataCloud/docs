...
The IPFS CLI is a tool you can use alongside your account to upload and manage files through your terminal. It also provides access to Pinata's Agents platform (beta), allowing you to create, manage, and interact with hosted agents directly from the command line. The source code can be found in the link below.
