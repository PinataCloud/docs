---
title: "Private IPFS CLI"
description: "The official CLI for the Private IPFS API written in Go"
---

![cover](https://dweb.mypinata.cloud/ipfs/QmNcdx9t48z7RQUXUZZHmuc4zBfyBxKLjDfEgmfhiop7j7?img-format=webp)

The Private IPFS CLI is a tool you can use alongside your account to upload and manage files through your terminal. The source code can be found in the link below.
