...
If you're a developer that needs to build decentralized applications then you will likely want to use the [Pinata SDK](/ipfs-sdk) or [Pinata API](/api-reference/introduction). These make it simple to upload files or raw JSON to IPFS!
