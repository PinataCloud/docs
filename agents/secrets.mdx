...
<Tip>
  OpenAI also supports subscription-based access (Codex subscription). This connects via OAuth instead of an API key.
</Tip>
...
On the agent's Secrets tab you'll see your connected AI providers at the top (showing whether you're using an API key or a Codex subscription), followed by any other variables and secrets you've attached.
