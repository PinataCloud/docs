...
- Which model is set as the default
- An **+ Add Model** button to enable more

## Add a Model

1. Click **+ Add Model** in the provider section
...
In the chat interface, use the model dropdown in the top right to switch between enabled models mid-conversation. This is useful for:
...
**OpenAI** — GPT models (including via Codex subscription)
