---
title: "Channels"
description: "Let people talk to your agent on Telegram, Slack, Discord, and rollout-dependent channels"
icon: "comments"
---
...
The current dashboard flows prominently expose Telegram, Slack, and Discord. The OpenAPI schema also includes WhatsApp channel types/status, so channel availability can vary by deployment and engine rollout.
