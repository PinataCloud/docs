...
{/* Screenshot: My Agents page (agents.pinata.cloud/agents) showing agent cards with status, description, and Chat button */}
...
- **Danger** — Agent details, workspace state, configuration, restart, and delete
