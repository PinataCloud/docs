...
Not sure what to do now? Check out our [Getting Started]() guide to jump into our API, or peek at our [API Reference]() if you know what you're looking for, or try out `npx create-pinata-app` in your terminal!
