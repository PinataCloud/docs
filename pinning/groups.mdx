...
<Info>At this time CIDs can only belong to one group at a time. If a CID is added to a Group while already being part of another, it will move the CID to the latest requested Group.</Info>
...
<Info>Deleting a Group that has CIDs inside of it will not unpin/delete the CIDs. Please use [/pinning/unpin](/api-reference/endpoint/unpin-file) to actually delete a file from your account</Info>
