---
title: "x402 payment instructions guide"
description: "Create, attach, and manage x402 payment instructions on Pinata to set prices, accept USDC, and monetize private IPFS files programmatically."
---
