...
Payment Instructions are the core mechanism for monetizing private IPFS content through the x402 protocol. This guide covers how to create, manage, and use Payment Instructions to monetize your content.
...
When a buyer accesses your x402 gateway URL:
...
2. Verifies payment with Coinbase Facilitator
3. Checks amount, recipient, and network match requirements
4. Serves the private content
5. Settles the transaction on-chain

## Best Practices

### Payment Amounts

- Amounts are in smallest unit (e.g., `"10000"` = 0.01 USDC with 6 decimals)
...
- Ensure your `pay_to` address is correct
