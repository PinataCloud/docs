---
title: "Private IPFS"
description: "Pinata Private IPFS keeps your content off the public DHT and only serves it to authorized requests, combining IPFS addressing with access control."
icon: "lock"
---
