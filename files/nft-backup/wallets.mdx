---
title: "Add wallets to back up NFTs"
description: "Add Ethereum, Polygon, and other EVM wallets to Pinata so it can find every NFT you own and back the underlying CIDs up to IPFS automatically."
---
