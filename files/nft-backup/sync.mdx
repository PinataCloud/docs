---
title: "Sync NFT collections to Pinata"
description: "Pin every CID referenced by your NFT collections to Pinata so the media and metadata stay available even if other pinning services go down."
---
