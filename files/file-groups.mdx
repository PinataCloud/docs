...
With the [SDK](/sdk/groups/public), you can create groups, add files to groups, list details about a group, and more! You can also mange groups using the [API](/api-reference/endpoint/create-group).
