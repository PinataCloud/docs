...
Groups help determine if a file uploaded through the Private IPFS API is private or publicly accessible. All file uploads are private by default, unless a file is:
...
With the [Private IPFS SDK](/sdk/groups), you can create groups, add files to groups, list details about a group, and more! You can also mange groups using the [Private IPFS API](/api-reference/endpoint/create-group).
