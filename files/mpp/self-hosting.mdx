---
title: "Self-host the Pinata MPP Server"
description: "Deploy your own Machine Payments Protocol server for Pinata on Cloudflare Workers with custom pricing, wallets, and request handling logic."
---
