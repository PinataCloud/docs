---
title: "MPP Server quickstart for IPFS uploads"
description: "Upload and download files from IPFS using the hosted Pinata MPP Server, pay per request with crypto, and skip account creation entirely."
---
