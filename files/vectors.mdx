---
title: "File vectors for AI (beta)"
description: "Upload a file to Pinata and vectorize it in one step on Private IPFS so AI apps can run similarity search and retrieval without separate storage."
icon: "microchip-ai"
---
