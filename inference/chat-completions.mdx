---
title: "Chat completions endpoint reference"
description: "Call the Pinata Inference chat completions endpoint, which is OpenAI compatible, to run hosted LLMs from your own apps with a single API key."
icon: "message"
---
