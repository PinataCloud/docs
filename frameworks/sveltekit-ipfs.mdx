...
Create a directory called `server` in the `src/lib` folder of the project and then make a file called `pinata.ts` inside of it. In that file we'll export an instance of the IPFS SDK that we can use throughout the rest of the app.
<Note>
