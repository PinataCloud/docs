...
```JSON
{"url":"https://uploads.pinata.cloud/v3/files/0195fc5a-4945-7612-a63e-aa9e9526a1fa?X-Algorithm=PINATA2&X-Date=1743695529&X-Expires=60&X-Method=%5B%22HEAD%22%2C%22PATCH%22%2C%22POST%22%5D&X-Upload-Option-Network=public&X-User-ID=ec50a085-a746-428d-b01d-167ac379fbd4&X-Signature=466982b46d8729f545514a8cd559678f99cdcb7830257ea4f42eed3ba7d5d393"}
```
