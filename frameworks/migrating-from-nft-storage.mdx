...
description: "Step-by-step guide for migrating NFT metadata and media from NFT.Storage to Pinata, including pinning workflow, gateway URLs, and code samples."
---
