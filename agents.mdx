...
{/* screenshot: create agent - identity step */}

### 2. Environment

Select a container template. The **Pinata Optimized Agent** environment includes Node.js, Python, and common CLI tools. State persists and syncs automatically.
...
{/* screenshot: create agent - connect step */}
...
{/* screenshot: telegram channel configuration */}
...
{/* screenshot: slack channel configuration */}
...
{/* screenshot: agent detail page */}

The detail page also includes:

- **Snapshots** — content-addressed captures of the agent environment, recorded every minute when changes are detected
...
{/* screenshot: OpenClaw settings dashboard */}
...
{/* screenshot: upload skill dialog */}
