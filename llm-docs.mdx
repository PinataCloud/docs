---
title: "LLM-ready docs for AI code editors"
description: "Feed the Pinata docs into ChatGPT, Claude, Cursor, or Zed using the llms.txt and AI-optimized doc bundles for better in-editor code completions."
icon: "sparkles"
---
