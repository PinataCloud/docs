...
```typescript
const signedUrl = await pinata.gateways.get("bafkreib4pqtikzdjlj4zigobmd63lig7u6oxlug24snlr6atjlmlza45dq")
```
...
Use the `IpfsHash` (aka `cid`) of a file to fetch it through a Gateway or create a URL
...
We got troops on the ground! 🫡 Come find us at our table on the 4th floor of the MLC, shoot us an email, or chat with us on [Discord](https://discord.com/channels/1293713095713226784/1303043963447545893)!
