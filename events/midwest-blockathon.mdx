...
<Card horizontal title="1st Place: $500 per Team Member" icon="trophy" >
</Card>

<Card horizontal title="2nd Place: $350 per Team Member" icon="medal" >
</Card>

<Card horizontal title="3rd Place: $250 per Team Member" icon="party-horn" >
</Card>


## Quickstart

<Card horizontal title="Sign Up for a Free Account!" icon="user-plus" href="https://app.pinata.cloud/register"></Card>
