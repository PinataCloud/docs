...
Awarded to the best app using Pinata. To qualify use either the [Files API](/sdk) or [IPFS API](/web3/sdk) as part of your app. App that have a heavy use case for uploads will have a greater chance of winning.
</Card>
