---
title: "Hack Midwest 2024"
description: "Everything you need to start hacking with Pinata"
'og:image': "https://dweb.mypinata.cloud/ipfs/QmRbPmnrHyGyzmVq4HkSqQ97aPk7V9wVRPAvTLECUKm9E4?img-format=webp"
---

![cover](https://dweb.mypinata.cloud/ipfs/QmRbPmnrHyGyzmVq4HkSqQ97aPk7V9wVRPAvTLECUKm9E4?img-format=webp)
...
<Info>
Almost all of our features are on the free account, but if you find yourself limited and need a paid account contact <a target="_blank" href="mailto:justin@pinata.cloud">justin@pinata.cloud</a>
</Info>
...
<Card horizontal title="$5000 - Pinata Challenge" icon="party-horn" >
Awarded to the best app using Pinata. To qualify, use either the [Files API](/sdk) or [IPFS API](/web3/sdk) as part of your app. Apps that have a heavy use case for uploads will have a greater chance of winning.
</Card>

<Card horizontal title="$2500 - AI Challnge" icon="sparkles" >
Awarded to the best app that uses Pinata as part of an AI stack. To qualify, use either the [Files API](/sdk) or [IPFS API](/web3/sdk) as part of a bigger AI stack. Creative use cases will have a greater chance of winning.
</Card>

<Card horizontal title="$2500 - Enterprise Challnge" icon="buildings" >
Best app using Pinata for an enterprise scale business solution. To qualify, use either the [Files API](/sdk) or [IPFS API](/web3/sdk) as part of a primary part of the app. Creative use cases will have a greater chance of winning.
</Card>
...
<Card title="How to Build a Chattanooga Video Wall" href="https://www.pinata.cloud/blog/how-to-build-a-chattanooga-video-wall/">
</Card>

<Card title="How To Build a Simple Podcast Hosting App" href="https://www.pinata.cloud/blog/how-to-build-a-simple-podcast-hosting-app/">
</Card>

<Card title="How to Create a Public Database With PGLite" href="https://www.pinata.cloud/blog/how-to-create-a-public-database-with-pglite/">
</Card>
