...
### [`/casts`](/farcaster/farcaster-api/endpoint/cast-by-hash)
...
### [`/channels`](/farcaster/farcaster-api/endpoint/channel-by-name)

The `/channels` endpoint can be used to fetch info about a specific channel or fetch a list of channels

### [`/users`](/farcaster/farcaster-api/endpoint/user-by-fid)
