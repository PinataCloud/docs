...
description: "Migrate from pinata 1.x or pinata-web3 to the unified Pinata SDK 2.x covering both public and private IPFS in a single package with v3 APIs."
icon: "code-branch"
---
