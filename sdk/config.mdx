---
title: "Config"
description: "Configure the Pinata SDK with your JWT, default Dedicated Gateway, custom headers, and network selection so every call uses the right context."
icon: "gear"
---
