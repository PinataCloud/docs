---
title: "files.public.addSwap"
description: "Pinata SDK files.public.addSwap remaps a public IPFS CID to point at new content using Hot Swaps. Requires the org:files:write permission."
---
