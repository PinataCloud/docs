---
title: "files.public.getSwapHistory"
description: "Pinata SDK files.public.getSwapHistory lists every Hot Swap mapping that has ever been set on a public IPFS CID. Requires org:files:read permission."
---
