---
title: "files.public.list"
description: "Pinata SDK files.public.list returns public IPFS files filtered by name, CID, group, key-value tags, and date. Requires the org:files:read permission."
---
