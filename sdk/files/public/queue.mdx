---
title: "files.public.queue"
description: "Pinata SDK files.public.queue returns the status of public IPFS pin-by-CID jobs queued for your account. Requires the org:files:read permission."
---
