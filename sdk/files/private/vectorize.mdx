---
title: "files.private.vectorize"
description: "Pinata SDK files.private.vectorize creates embeddings for an existing private IPFS file so it can be queried for similarity search later on."
---
