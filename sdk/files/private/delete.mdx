---
title: "files.private.delete"
description: "Pinata SDK files.private.delete unpins one or more private IPFS files by ID and frees up account storage. Requires the org:files:write permission."
---
