---
title: "files.private.list"
description: "Pinata SDK files.private.list returns private IPFS files filtered by name, CID, key-value tags, group, and date. Requires org:files:read permission."
---
