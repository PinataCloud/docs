---
title: "files.private.deleteSwap"
description: "Pinata SDK files.private.deleteSwap removes a Hot Swap mapping on a private IPFS CID. Requires the org:files:write permission to call."
---
