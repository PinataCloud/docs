---
title: "files.private.update"
description: "Pinata SDK files.private.update changes the name, group, or key-value metadata on a private IPFS file. Requires the org:files:write permission."
---
