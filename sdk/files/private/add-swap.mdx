---
title: "files.private.addSwap"
description: "Pinata SDK files.private.addSwap remaps an existing private IPFS CID to a new one through Hot Swaps. Requires the org:files:write permission."
---
