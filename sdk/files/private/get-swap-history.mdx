---
title: "files.private.getSwapHistory"
description: "Pinata SDK files.private.getSwapHistory lists Hot Swap mappings ever created for a private IPFS CID. Requires the org:files:read permission."
---
