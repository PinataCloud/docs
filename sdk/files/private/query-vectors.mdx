---
title: "files.private.queryVectors"
description: "Pinata SDK files.private.queryVectors runs similarity search over vectorized private IPFS files in a group. Requires the org:files:write permission."
---
