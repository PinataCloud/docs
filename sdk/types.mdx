---
title: "Pinata SDK type definitions"
description: "Reference for the TypeScript types exported by the Pinata SDK, including analytics, config, files, gateways, groups, keys, signatures, and uploads."
---
