---
title: "requests"
description: "Pinata SDK analytics.requests queries gateway request counts by domain, content type, and time range. Requires the org:analytics:read permission."
---
