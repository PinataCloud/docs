---
title: "upload.private.createSignedURL"
description: "Pinata SDK upload.private.createSignedURL mints a presigned upload URL so a client can upload directly to private IPFS without exposing your JWT."
---
