...
description: "Pinata SDK upload.private.file uploads a single file to private IPFS and returns the resulting CID, file ID, and metadata. Requires org:files:write."
---
