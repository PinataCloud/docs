---
title: "upload.private.base64"
description: "Pinata SDK upload.private.base64 uploads a base64-encoded payload to private IPFS, useful for server actions that already encode binary data."
---
