---
title: "upload.private.url"
description: "Pinata SDK upload.private.url fetches content from an HTTP URL and uploads it to private IPFS, returning a CID and file ID for the saved data."
---
