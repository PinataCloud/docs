---
title: "upload.private.fileArray"
description: "Pinata SDK upload.private.fileArray uploads multiple files together to private IPFS as a single directory CID. Requires org:files:write."
---

<Warning>
  This method is currently not supported for PRivate files
</Warning>
...
const upload = await pinata.upload.private.fileArray([file1, file2])
```
...
Add optional keyvalues to folder
