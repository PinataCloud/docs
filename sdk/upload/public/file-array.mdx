---
title: "upload.public.fileArray"
description: "Pinata SDK upload.public.fileArray uploads multiple files together to public IPFS as a single directory CID. Requires org:files:write."
---
