---
title: "upload.public.json"
description: "Pinata SDK upload.public.json uploads a JSON object to public IPFS, automatically serializing it and returning the resulting CID and file ID."
---
