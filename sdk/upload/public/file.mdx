...
description: "Pinata SDK upload.public.file uploads a single file to public IPFS and returns the resulting CID, file ID, and metadata. Requires org:files:write."
---
