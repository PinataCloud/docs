---
title: "upload.public.createSignedURL"
description: "Pinata SDK upload.public.createSignedURL mints a presigned upload URL so a client can upload directly to public IPFS without exposing your JWT."
---
