---
title: "upload.public.url"
description: "Pinata SDK upload.public.url fetches content from an HTTP URL and uploads it to public IPFS, returning a CID and file ID for the saved data."
---
