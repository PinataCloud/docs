---
title: "signatures.public.delete"
description: "Pinata SDK signatures.public.delete removes the wallet signature attached to a public IPFS CID. Requires the org:files:write permission."
---
