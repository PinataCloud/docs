---
title: "signatures.private.add"
description: "Pinata SDK signatures.private.add attaches a wallet signature to a private IPFS CID so consumers can later verify its origin and authenticity."
---
