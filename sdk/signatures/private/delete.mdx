---
title: "signatures.private.delete"
description: "Pinata SDK signatures.private.delete removes the wallet signature attached to a private IPFS CID. Requires the org:files:write permission."
---
