---
title: "x402.paymentInstructions.create"
description: "Pinata SDK x402.paymentInstructions.create defines a new USDC price and wallet that consumers must pay before accessing private IPFS files."
---
