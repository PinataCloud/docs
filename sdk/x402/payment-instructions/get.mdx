---
title: "x402.paymentInstructions.get"
description: "Pinata SDK x402.paymentInstructions.get fetches a single x402 payment instruction by ID, including price, wallet, network, and associated CIDs."
---
