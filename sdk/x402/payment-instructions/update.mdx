---
title: "x402.paymentInstructions.update"
description: "Pinata SDK x402.paymentInstructions.update changes the price, wallet, or network on an existing x402 payment instruction for private IPFS files."
---
