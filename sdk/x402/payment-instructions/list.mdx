---
title: "x402.paymentInstructions.list"
description: "Pinata SDK x402.paymentInstructions.list returns and filters every x402 payment instruction on your Pinata account for monetized private files."
---
