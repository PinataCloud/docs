---
title: "x402.cids.list"
description: "Pinata SDK x402.cids.list returns the private IPFS CIDs currently associated with a given x402 payment instruction on your Pinata account."
---
