---
title: "x402.cids.remove"
description: "Pinata SDK x402.cids.remove detaches a private IPFS CID from an x402 payment instruction so it no longer requires payment to access."
---
