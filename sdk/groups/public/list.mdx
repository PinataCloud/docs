---
title: "groups.public.list"
description: "Pinata SDK groups.public.list returns public file groups on your account, filtered by name or pagination cursor. Requires the org:groups:read permission."
---
