---
title: "keys.list"
description: "Pinata SDK keys.list returns the API keys on your Pinata account, including name, scopes, usage counts, and timestamps. Requires the org:write permission."
---
