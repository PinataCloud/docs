---
title: "keys.create"
description: "Pinata SDK keys.create generates a new scoped API key for your Pinata account with selectable permissions and usage limits. Requires org:write."
---
