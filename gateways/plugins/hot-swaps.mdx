---
title: "Hot Swaps plugin for gateways"
description: "Install the Hot Swaps gateway plugin to remap a stable IPFS CID to new content over time, useful for mutable references behind a fixed URL."
icon: "rotate"
---
