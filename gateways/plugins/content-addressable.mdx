...
description: "Use the Content Addressable plugin to attach CID signatures to gateway responses so consumers can verify the content they fetch is authentic."
icon: "file-signature"
---
