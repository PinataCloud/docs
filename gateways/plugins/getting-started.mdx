...
const installPlugin = await fetch("https://api.pinata.cloud/v3/ipfs/gateway_plugins/8673cd80-bf53-4bca-b684-bec1d6bdf004", {
  method: "GET",
  headers: {
    "Content-Type": "application/json",
    Authorization: `Bearer ${PINATA_JWT}`
...
```typescript Install Plugin
const uninstallPlugin = await fetch("https://api.pinata.cloud/v3/ipfs/gateway_plugins/8673cd80-bf53-4bca-b684-bec1d6bdf004/plugin/1", {
  method: "DELETE",
  headers: {
    "Content-Type": "application/json",
    Authorization: `Bearer ${PINATA_JWT}`
