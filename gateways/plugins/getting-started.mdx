---
title: "Getting started with gateway plugins"
description: "Install Pinata Dedicated Gateway plugins like Hot Swaps and Content Addressable to extend your IPFS delivery system with new request features."
icon: "play"
---
