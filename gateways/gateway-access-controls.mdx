...
description: "Lock down a Pinata Dedicated Gateway using gateway keys, IP allowlists, and host origin restrictions to prevent abuse and control who fetches."
