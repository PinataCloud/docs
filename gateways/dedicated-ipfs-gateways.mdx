...
<Info>The only way to open a Dedicated Gateway and allow any CID to go through is to add a Gateway Access Control</Info>
...
<Info>[IPFS Gateway Tools](https://github.com/PinataCloud/ipfs-gateway-tools)</Info>
...
<Info>If you're using a Dedicated Gateway for your NFT project, be sure to check out [this guide](https://knowledge.pinata.cloud/en/articles/6461213-token-uris-in-nft-projects) on how you should do that.</Info>
