...
description: "Resize, reformat, and compress images on the fly through your Pinata Dedicated Gateway to speed up page loads without preprocessing content."
...
Image Optimizations are built into both [`get`](/sdk/gateways/public/get) and [`createSignedURL`](/sdk/gateways/private/create-signed-url) methods of the SDK.
