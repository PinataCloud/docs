...
<CardGroup cols={2}>
  <Card title="Basic IPFS Concepts" icon="cube" color="#00cc92">
  ...
  <Card title="👯 Workspaces" href="https://docs.pinata.cloud/account-management/workspaces">
  Have a whole team you need to collab with? With Workspaces, you can add any team member, even if they don’t already have a Pinata account. Navigate to the Workspaces page, enter an email address, and start collaborating.

  </Card>
  <Card title="📈 Analytics" href="https://docs.pinata.cloud/account-management/workspaces">
analytic stuff
